  ...
  render() {
    ...
    return (
      ...
      <div className={styles.customFont}>
        ...
        <div className={styles.customHeading} style={{ fontSize: this.props.headingsize }}> {this.props.heading}</div>
        <button onClick={this.handleButtonClick} style={buttonStyle}>
          Links bearbeiten
        </button>
        </div>
        {!this.state.showEditQuicklinks && (
          <QuickLinksCustom description={this.props.description} context={this.props.context} columns={this.props.columns}/*style={quickLinksStyle}*/ />
        )}

        {this.state.showEditQuicklinks && (
          <div>
            <EditQuicklinks description={this.props.description} context={this.props.context} handleButtonClick={this.handleButtonClick} /*style={quickLinksStyle}*/ />
          </div>
        )}
      </div>
